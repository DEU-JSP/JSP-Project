...
<div align="center">
    ...
    <form name=form1 method=post action=addrbook_control.jsp>
        ...
        <table border="1">
            <tr>
                <th>이 름</th>
                <td><input type="text" name="ab_name" <%=ab.getAb_name() %> ></td>
            </tr>
            <tr>
                <th>email</th>
                <td><input type="text" name="ab_email" <%=ab.getAb_email() %> ></td>
            </tr>
            <tr>
                <th>전화번호</th>
                <td><input type="text" name="ab_tel" <%=ab.getAb_tel() %> ></td>
            </tr>
            <tr>
                <th>생 일</th>
                <td><input type="date" name="ab_birth" <%=ab.getAb_birth() %> ></td>
            </tr>
            <tr>
                <th>학 교</th>
                <td><input type="text" name="ab_comdept" <%=ab.getAb_comdept() %> ></td>
            </tr>
            <tr>
                <th>메 모</th>
                <td><input type="text" name="ab_memo" <%=ab.getAb_memo() %> ></td>
            </tr>
            <tr>
